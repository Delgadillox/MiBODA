...
const Gifts = () => {
	...
	function sendWp(number) {
		try {
			...
			const enlaceWhatsApp = `https://wa.me/${number}?text=${encodeURIComponent(
				mensaje
			)}`;
		...
		<div name='gifts' className='gifts'>
			<div className='content'>
				<div className='top-content'>
					<span className='title'>Mesa&nbsp; deRegalos</span>
					<br />
					<br />
					<span className='text'>
						Su presencia es nuestro mejor regalo, pero si desea brindarnos algo
						más, será recibido con gran aprecio.
					</span>
					<div className='container'>
						<div className='cardDiv'>
							...
							<div className='accountInfo'>
								<span>
									<strong>Nombre:</strong> Jose Pablo Delgadillo
								</span>
								<br />
								<span>
									<strong>CLABE:</strong>
						...
						<div className='giftDiv'>
							<div className='liverpoolDiv'>
								...
								<a
									href='https://mesaderegalos.liverpool.com.mx/milistaderegalos/51381544'
									target='_blank'
								>
									<img
										className='lv'
							...
							<div className='searsDiv'>
								...
								<a
									href='https://www.sears.com.mx/Mesa-de-Regalos/123630/te-invito-a-mi-boda-pablo-mayte'
									target='_blank'
								>
									<img
										src='https://kakulimexico.com/wp-content/uploads/2023/04/logo_sears.png'
										alt='Mesa de regalos Sears'
									/>
								</a>
							</div>
						</div>
